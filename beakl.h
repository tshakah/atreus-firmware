int layer0[44] = {
    KEY_Q, KEY_H, KEY_O, KEY_U, KEY_X, KEY_0, KEY_G, KEY_C, KEY_R, KEY_F, KEY_Z,
    KEY_Y, KEY_I, KEY_E, KEY_A, KEY_PERIOD, KEY_0, KEY_D, KEY_S, KEY_T, KEY_N, KEY_B,
    KEY_J, KEY_SLASH, KEY_COMMA, KEY_K, KEY_QUOTE, KEYBOARD_LEFT_ALT, KEY_W, KEY_M, KEY_L, KEY_P, KEY_V,
